    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <table class="table">
                ...
                <tr>
                    <td>
                        <strong>Fórmula Obstétrica</strong><br>
                        {{ $traslado->formula_obstetrica ?: 'N/A' }}
                    </td>
                    <td>
        ...
        <div class="section">
            <div class="section-title">Cierre y Seguimiento</div>
            <table class="table">
