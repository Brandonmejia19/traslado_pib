...
class TrasladoSecundario24Resource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Traslados 24H';
    protected static ?string $navigationIcon = 'healthicons-o-critical-care';
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\EditAction::make()->modalWidth(MaxWidth::SevenExtraLarge)->iconButton()->color('primary')
                    ->hidden(fn(TrasladoSecundario $record) => $record->estado === 'Finalizado' || auth()->user()->cargo === 'Operador' || auth()->user()->cargo === 'Gestor'),
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ...
            ->orWhere('estado', 'En curso'); // También incluir registros en curso
    }
