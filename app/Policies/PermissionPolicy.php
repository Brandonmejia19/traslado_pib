...
class PermissionPolicy
{
    ...
    {
        return $user->checkPermissionTo(permission: 'delete Permission');
    }
    ...
    {
        return $user->checkPermissionTo(permission: 'restore Permission');
    }
    ...
    {
        return $user->checkPermissionTo(permission: 'force-delete Permission');
    }
}
