...
class RolePolicy
{
    ...
    {
        return $user->checkPermissionTo(permission: 'delete Role');
    }
    ...
    {
        return $user->checkPermissionTo(permission: 'restore Role');
    ...
    {
        return $user->checkPermissionTo(permission: 'force-delete Role');
    }
}
